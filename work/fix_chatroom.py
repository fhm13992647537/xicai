...
'''
with open(r'C:\Users\付建康\Documents\Codex\2026-06-06\web-react-tailwind-css-leancloud-vercel\campus-circle\src\pages\ChatRoomPage.jsx', 'w', encoding='utf-8') as f:
    f.write(code)
print('ChatRoomPage written')
